...
INSERT INTO `bill_details_amazon` VALUES (1,1,1);
...
CREATE TABLE `broker_transaction_amazon` (
  ...
  `payment_rxd_date` datetime DEFAULT NULL,
  PRIMARY KEY (`bill_no`),
...
INSERT INTO `user_details_paypal` VALUES ('alice',800,'customer','a6113f9c-0643-43'),('amazon',200,'vendor','01ff988c-5eb4-41');
...
INSERT INTO `vendor_inventory_amazon` VALUES (1,10,5,100,'A'),(2,20,20,150,'B'),(3,5,4,50,'C');
...
-- Dump completed on 2014-12-02 20:34:14
