...
--
-- Table structure for table `alice`
--
...
--
-- Dumping data for table `alice`
--

LOCK TABLES `alice` WRITE;
/*!40000 ALTER TABLE `alice` DISABLE KEYS */;
INSERT INTO `alice` VALUES ('a6113f9c-0643-43','paypal');
/*!40000 ALTER TABLE `alice` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `user_details_paypal` (
  ...
  `user_public_key` varchar(999) DEFAULT NULL,
...
INSERT INTO `user_details_paypal` VALUES (1,'alice',1000,'','customer','a6113f9c-0643-43',''),(2,'amazon',0,'','vendor','01ff988c-5eb4-41','');
...
-- Dump completed on 2014-11-23 15:14:47
